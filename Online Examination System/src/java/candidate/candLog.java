 ...
 * @author Asus
 */
@WebServlet(name = "candLog", urlPatterns = {"/candLog"})
public class candLog extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String pwd=request.getParameter("Password");
         ...
         statement = conn.createStatement();
           ...
           ResultSet rs = statement.executeQuery("SELECT User_Id,Password FROM candidate_detail");
           while(rs.next()){
