    ...
    <div class="form-group" >
      ...
      <input type="password" class="form-control" id="pwdCand" name="Password">
        ...
        <div class="modal-footer">
            ...
            <button onclick="candlog()"  class="btn btn-default" style="background-color:dodgerblue; width: 70px;" data-dismiss="modal">Login</button>
   ...
   <!-- Engineering button -->
    ...
    <ul id="others" class="dropdown-menu" style="position:absolute; top: {{height*67}}px; left: {{width*40}}px; overflow: scroll; font-family:Comic Sans MS; width: 250px;height: 120px; font-size: 14px;  background-color:lightgray;">
       ...
       <script> 
         ...
         function candlog(){
           // alert("SFaf");
            var usr=document.getElementById('usrCand').value;
            var pwd=document.getElementById('pwdCand').value;
             // alert(usr+" "+pwd);
                $.ajax({
                       type:'POST',
                       url:'candlogin',
                       data:{User_Id:usr,Password:pwd},
                    ...
                    //   dataType: "xml",
                       ...
                       success: function(result){
                         //  alert(result);
                           if(result=="false"){
                               alert("user Id and password are not correct");
                           }
                           else{
