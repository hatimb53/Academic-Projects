 ...
 * @author Asus
 */
@WebServlet(name = "examReg", urlPatterns = {"/examReg"})
public class examReg extends HttpServlet {
 ...
 statement = conn.prepareStatement("insert into examreg values(?,?)");
 HttpSession session=request.getSession();
 statement.setString(1,session.getAttribute("User_Id").toString());
 statement.setString(2,session.getAttribute("Exam_Name").toString());
