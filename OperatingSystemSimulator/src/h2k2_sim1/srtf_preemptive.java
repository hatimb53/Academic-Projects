  ...
  for(int j=0;j<iorear;j++)
       ...
       while(io[iorear].bound[io[iorear].status]==true)
   {
      ...
      { 
          ...
          {
              if(ready[frnt1].burst_time-ready[frnt1].status>ready[frnt2].burst_time-ready[frnt2].status)
              {
                  temp=ready[frnt1];
       ...
       if(ex_status==false)
    {
        ...
        {if(ready[rdfront].burst_time-ready[rdfront].status<execute.burst_time-execute.status)
              {
                  temp=ready[rdfront];
